...
st.set_page_config(initial_sidebar_state="expanded", page_title="Controller Health", page_icon="📡", layout="wide")

# Apply ENKA branding
apply_enka_theme()
render_sidebar_branding("09_Controller_Health_And_Communications")
